...
ENV PORT=${PORT}
ARG UPLOAD_ENDPOINT
ENV UPLOAD_ENDPOINT=${UPLOAD_ENDPOINT}
ARG NEXT_PUBLIC_UPLOAD_ENDPOINT
ENV NEXT_PUBLIC_UPLOAD_ENDPOINT=${NEXT_PUBLIC_UPLOAD_ENDPOINT}
ARG NEXT_PULBIC_UPLOAD_DOMAIN
ENV NEXT_PULBIC_UPLOAD_DOMAIN=${NEXT_PULBIC_UPLOAD_DOMAIN}
ARG MINIO_KEY
ENV MINIO_KEY=${MINIO_KEY}
ARG MINIO_SECRET
ENV MINIO_SECRET=${MINIO_SECRET}
ARG PATH_UPLOAD
ENV PATH_UPLOAD=${PATH_UPLOAD}
