  ...
  return (
    ...
    >
      ...
      <SidebarContent>
          ...
          <SidebarGroupContent className="p-2">
            <div className="flex items-center gap-3">
              <Checkbox
                id="groupProduct"
                className="ml-2"
                checked={filters.groupBy === "product"}
                onCheckedChange={(check) =>
                  onFiltersChangeAction("groupBy", check ? "product" : "time")
                }
              />
        ...
        {/* View Value Selector (for graphs only) */}
        {viewMode === "graph" && (
          <SidebarGroup>
            <SidebarGroupLabel className="flex items-center gap-2">
            ...
            <SidebarGroupContent>
              <ToggleGroup
                type="single"
                value={filters.viewValue}
                onValueChange={(value) =>
                  value && onFiltersChangeAction("viewValue", value)
                }
